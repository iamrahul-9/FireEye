...
export default function ReportDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (loading) {
        return <FireEyeLoader fullscreen text="Loading Inspection Report..." />
    }
    ...
    if (!inspection) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-4">
                ...
                <Link href="/reports" className="liquid-button inline-flex items-center text-sm font-medium">
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-20">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button
                        onClick={async () => await generateReportPDF([inspection], `Inspection Report - ${inspection.client.name}`)}
                        className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/20 rounded-xl font-medium transition-colors"
                    >
